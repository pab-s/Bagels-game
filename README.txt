...
The computer generates a three digit number where each digit must be unique. 

You are provided with 20 turns to guess the number. 

The computer can give the following hints in response to each guess:
...
Imagine that the computer is thinking of the number 398. 
